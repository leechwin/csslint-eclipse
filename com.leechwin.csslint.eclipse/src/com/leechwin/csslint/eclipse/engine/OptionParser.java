...
class OptionParser {
    ...
    public <T> T parse(Class<T> clazz, String value) {
        try {
            ...
            // There's no contract for this, but in the cases we need it for, it should work.
            ...
            // Can never happen. If the method can't be accessed, we get a NoSuchMethodException first, instead.
            throw new RuntimeException(e);
